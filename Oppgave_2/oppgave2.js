...
const newusers = [{ id: 8, name: "Anne", age: 6 }];
...
const handleSearch = () => {
  ...
  console.log(searchName, newusers);
  if (searchName) {
    ...
    console.log("Vi fant", searchResult);
    if (searchResult) {
      ...
      userUl.innerHTML = "Finner ikke brukeren";
    }
  } else {
...
const handleFilter = () => {
  ...
  if (filterValue && Number(filterValue)) {
    ...
    if (filterResult && filterResult.length > 0) {
      ...
      userUl.innerHTML = "Det finnes ingen brukere over denne alderen";
    }
  } else {
